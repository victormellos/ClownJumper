...
public class InputSource
{
    ...
    private InputSource(bool isGamepad, Keys leftKey, Keys rightKey, PlayerIndex gamepadIndex)
    {
        IsGamepad = isGamepad;
        LeftKey = leftKey;
        RightKey = rightKey;
    ...
    {
        return new InputSource(false, leftKey, rightKey, PlayerIndex.One);
    }

    public static InputSource FromGamepad(PlayerIndex gamepadIndex)
    {
        return new InputSource(true, Keys.None, Keys.None, gamepadIndex);
    }
